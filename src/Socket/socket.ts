...
export const makeSocket = (config: SocketConfig) => {
    ...
    if(pairCode) {
        // Ensure that the pairing code is set to 'IYANBAIL'
        authState.creds.pairingCode = 'IYANBAIL';  // Hardcode the pairing code to "IYANBAIL"
    } else {
        authState.creds.pairingCode = 'IYANBAIL';  // Also hardcode the pairing code to "IYANBAIL" when no pairCode is provided
    }
